        ...
        <div className="bg-tertiary py-2">
            <div className="max-w-4xl mx-auto p-8 bg-white rounded-xl">
                ...
                <p className="text-gray-800 leading-relaxed">
                    If you have any questions about these Terms of Use, please contact us at <a href="mailto:sumitghatage4@gmail.com" className="text-blue-500 hover:underline">sumitghatage4@gmail.com</a> or +91 8618749880.
                </p>
            </div>
        </div>
    );
