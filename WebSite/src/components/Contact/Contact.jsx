...
function Contact() {
  return (
    <div className="relative flex items-top justify-center min-h-screen bg-gray-100">
      <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
        <div className="mt-8 overflow-hidden">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <form className="p-6 bg-white sm:rounded-lg">
              ...
              <input
                ...
                className="w-full mt-2 py-3 px-4 rounded-lg border border-gray-300 text-gray-800 focus:outline-none focus:border-orange-500"
              />

              <label htmlFor="email" className="text-sm font-semibold text-gray-600 mt-4">
                Email
              </label>
              <input
                type="email"
              ...
              <label htmlFor="tel" className="text-sm font-semibold text-gray-600 mt-4">
                Telephone Number
              </label>
              <input
                type="tel"
