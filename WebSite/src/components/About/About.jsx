            ...
            <div className="bg-gray-50 p-4 sm:p-4 md:p-10 rounded-lg shadow-lg m-2 md:mx-8 lg:mx-16 font-marathi">
                ...
                <div>
                    ...
                    <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 pl-5 md:pl-6">
                        ...
                        <li className="text-gray-900">
                            <span className="font-semibold">भारतीय पशुचिकित्सा महासंघ (VSFI) अध्यक्ष :</span> हा महासंघ पशुवैद्यकांच्या हितसंबंधांचे रक्षण आणि त्यांच्या व्यवसायाच्या उन्नतीसाठी कार्यरत आहे.
                        </li>
                        <li className="text-gray-900">
                            <span className="font-semibold">पशुवैद्यकीय, पशुसंवर्धन व दुग्ध व्यवस्थापन सेवा संघ महाराष्ट्र राज्य :</span> या संघाने महाराष्ट्र राज्यात पशुवैद्यक, पशुसंवर्धन आणि दुग्ध व्यवस्थापन क्षेत्रात सेवा देत आहेत.
                        </li>
                    </ul>
                    ...
                    <ul className="list-disc list-inside text-gray-700 mb-4 space-y-2 pl-5 md:pl-6">
                        ...
                        <li className="text-gray-900">ते जागतिक पशुवैद्यकीय कायद्यांचे अभ्यासक मानले जातात.</li>
                        <li className="text-gray-900">त्यांनी अखिल भारतीय सरकारी आणि खाजगी पदविकाधारक पशुवैद्यकांसाठी आधारस्तंभ म्हणून कार्य करीत आहेत.</li>
                    </ul>
