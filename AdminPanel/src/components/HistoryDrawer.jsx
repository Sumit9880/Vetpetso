...
const HistoryDrawer = ({ isOpen, onClose, data }) => {
                            ...
                            <div className="h-full rounded-l-xl flex flex-col bg-white shadow-xl">
                                ...
                                <div className="relative flex-1 overflow-y-auto px-4 sm:px-6">
                                    ...
                                    <form onSubmit={handleSubmit} className={`${loader ? 'hidden' : ''} py-4`}>
                                        {/* <div className="mt-4">
                                            <label htmlFor="TITLE" className="block pl-1 mt-1 font-medium text-gray-700">History Title</label>
                                        ...
                                        <div className="mt-4 flex justify-between">
                                            <div>
                                                <label htmlFor="DATE" className="block pl-1 mt-1 font-medium text-gray-700">History Date</label>
                                        ...
                                        <div className="mt-1">
                                            <label htmlFor="SUMMARY" className="block pl-1 mt-1 font-medium text-gray-700">Summary</label>
                                        ...
                                        <div className="mt-1">
                                            <label className="block pl-1 mt-1 font-medium text-gray-700">Upload PDF</label>
                                            {
