...
const SemenCompanyDrawer = ({ isOpen, onClose, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoader(true);
            const method = formData.ID ? 'api/semenCompany/update' : 'api/semenCompany/create';
                            ...
                            <div className="h-full rounded-l-xl flex flex-col bg-white shadow-xl">
                                ...
                                <div className="px-4 sm:px-6">
                                    <div className="flex h-16 items-center border-b justify-between sticky top-0 bg-white z-10">
                                        <h2 className="text-lg font-bold text-gray-900">{formData.ID ? 'Update Semen Company' : 'Add Semen Company'}</h2>
                                ...
                                <div className="relative flex-1 overflow-y-auto px-4 sm:px-6">
                                    ...
                                    <form onSubmit={handleSubmit} className={`${loader ? 'hidden' : ''} py-4`}>
                                        ...
                                        <MultiSelectComponent
                                            options={[
                                                { label: 'Semen', value: 'SEMEMN' },
                                                { label: 'Dyed', value: 'DYE' },
                                            ]}
                                            label="Type"
                                            selectedOptions={formData.TYPE}
                                            onChangeOptions={(e) => setFormData({ ...formData, TYPE: e })}
...
export default SemenCompanyDrawer;
