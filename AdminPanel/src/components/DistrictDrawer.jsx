...
const DistrictDrawer = ({ isOpen, onClose, data }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            setLoader(true);
            const method = formData.ID ? 'api/district/update' : 'api/district/create';
                            ...
                            <div className="h-full rounded-l-xl flex flex-col bg-white shadow-xl">
                                ...
                                <div className="px-4 sm:px-6">
                                    <div className="flex h-16 items-center border-b justify-between sticky top-0 bg-white z-10">
                                        <h2 className="text-lg font-bold text-gray-900">{formData.ID ? 'Update District' : 'Add District'}</h2>
