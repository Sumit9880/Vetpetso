    ...
    return (
        ...
        <>
            ...
            <Modal
                ...
                onRequestClose={() => { setPreview({ ...preview, isVisible: false }) }}
            >
                <Text onPress={() => setPreview({ ...preview, isVisible: false })} style={{ backgroundColor: 'rgba(0,0,0,.7)', zIndex: -1, position: 'absolute', top: 0, bottom: 0, left: 0, right: 0 }}></Text>
