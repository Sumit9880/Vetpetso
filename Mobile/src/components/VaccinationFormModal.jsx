    ...
    const handleImageSelection = async (source) => {
        try {
            ...
            const imageFile = {
                uri: image.path,
                type: image.mime,
                name: `patientImage-${vaccinationData.ID}.${image.mime.split('/')[1]}`,
            };

            const apiResponse = await apiUpload('upload/patientImage', imageFile, vaccinationData.ID);
                    ...
                    <View style={styles.container}>
                        ...
                        <View style={[styles.splitContainer, { marginTop: 15 }]}>
                            <View style={[styles.dropdown, { height: 165, justifyContent: 'center', alignItems: 'center', padding: 10, paddingBottom: 0 }]}>
                                <TouchableOpacity disabled={vaccinationData.ID ? true : false} onPress={chooseImageSource}>
